...
double mx_limit_upper = 25.5; //cm
double mx_limit_lower = 10.5;
    ...
    if(autonomous){
        switch (current_phase) {
            ...
            case PHASE2:
                ...
                if(tomato_z < -1 || tomato_z > 1 || tomato_x < tomato_best -1.2 || tomato_x > tomato_best + 0.2){
            ...
            case KOBUKI:
                ...
                if(tomato_x < 26 && tomato_x >= 24) command.z = 0.3;
                if(tomato_x < 24 && tomato_x >= tomato_best) command.z = 0.15;
                if(tomato_x < 27 && tomato_x > 0) fine_adjustment = true;
